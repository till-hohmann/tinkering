...
export function buildBackup(programs, sessions, iso, prefs = null, installId = null) {
  // installId rides along because restoreBackup adopts it — without it, a new
  // phone restored from a FILE looks like a stranger to the cloud Worker and
  // every push is refused, while the same restore from the cloud works.
