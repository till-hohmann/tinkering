...
// ⚠ ALL THREE TEXT TIERS CLEAR WCAG AA (4.5:1) ON ALL FOUR SURFACES, in every
// theme. They did not: --text-faint measured 2.12-2.34 against its own darkest
// background, and --text-dim only scraped 4.44 in Slate.
//
// The first fix only lifted faint to the 3:1 perceptibility floor, on the
// reasoning that reaching 4.5 would collapse it into --text-dim. That was true
// of the ORIGINAL dim, and the wrong conclusion: the answer is to move BOTH —
// faint up to the lightest value that clears 4.5, and dim up again above it.
// Every theme now has ~2.2 of contrast-ratio headroom between the two, so the
// hierarchy is intact and nothing on screen is below AA.
//
// The consequence is deliberate and visible: quiet text across the whole app is
// lighter than it was. That is what full AA costs on a near-black ground.
...
export const THEMES = [
  {
    ...
    vars: {
      ...
      "--text": "#f1f4f9", "--text-dim": "#adb4c1", "--text-faint": "#8b929f",
  ...
  },
  {
    ...
    vars: {
      ...
      "--text": "#eef4ff", "--text-dim": "#afbbd0", "--text-faint": "#8d99ae",
  ...
  },
  {
    ...
    vars: {
      ...
      "--text": "#f8f2ea", "--text-dim": "#bcb1a4", "--text-faint": "#9a8f82",
  ...
  },
  {
    ...
    vars: {
      ...
      "--text": "#f3f0ff", "--text-dim": "#b4aece", "--text-faint": "#928cac",
  ...
  },
  {
    ...
    vars: {
      ...
      "--text": "#eef1f5", "--text-dim": "#b2bac5", "--text-faint": "#9098a3",
